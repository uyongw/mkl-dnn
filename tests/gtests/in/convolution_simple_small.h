...
INST_TEST_CASE(SimpleSmall_1stconv_lastconv,
    PARAMS(FMT_DATA_1ST, FMT_WEIGHTS_BLOCKED_1ST, FMT_BIAS, FMT_DATA_BLOCKED16,
        2, 1, 1, 13, 13, 32, 12, 12, 3, 3, 0, 0, 1, 1),
    PARAMS(FMT_DATA_1ST, FMT_WEIGHTS_BLOCKED_1ST, FMT_BIAS, FMT_DATA_BLOCKED16,
        2, 1, 3, 13, 13, 32, 12, 12, 3, 3, 0, 0, 1, 1),
    PARAMS(FMT_DATA_1ST, FMT_WEIGHTS_BLOCKED_1ST, FMT_BIAS, FMT_DATA_BLOCKED16,
        2, 1, 3, 32, 32, 32, 32, 32, 3, 3, 1, 1, 1, 1),
    PARAMS(FMT_DATA_1ST, FMT_WEIGHTS_BLOCKED_1ST, FMT_BIAS, FMT_DATA_BLOCKED16,
        2, 1, 4, 13, 13, 32, 12, 12, 3, 3, 0, 0, 1, 1),
    PARAMS(FMT_DATA_BLOCKED16, FMT_WEIGHTS_BLOCKED_LAST, FMT_BIAS, nhwc,
        1, 1, 32, 1, 1, 1, 2, 2, 2, 2, 1, 1, 1, 1),
    PARAMS(FMT_DATA_BLOCKED16, FMT_WEIGHTS_BLOCKED_LAST, FMT_BIAS, nhwc,
        2, 1, 32, 5, 5, 1, 4, 4, 2, 2, 0, 0, 1, 1),
    PARAMS(FMT_DATA_BLOCKED16, FMT_WEIGHTS_BLOCKED_LAST, FMT_BIAS, nhwc,
        1, 1, 32, 5, 5, 3, 4, 4, 2, 2, 0, 0, 1, 1),
    PARAMS(FMT_DATA_BLOCKED16, FMT_WEIGHTS_BLOCKED_LAST, FMT_BIAS, nhwc,
        1, 1, 32, 1, 1, 3, 2, 2, 2, 2, 1, 1, 1, 1),
    PARAMS(FMT_DATA_BLOCKED16, FMT_WEIGHTS_BLOCKED_LAST, FMT_BIAS, nhwc,
        1, 1, 32, 5, 5, 4, 4, 4, 2, 2, 0, 0, 1, 1),
    PARAMS(FMT_DATA_BLOCKED16, FMT_WEIGHTS_BLOCKED_LAST, FMT_BIAS, nhwc,
        1, 1, 32, 32, 32, 4, 32, 32, 3, 3, 1, 1, 1, 1),
    PARAMS(FMT_DATA_1ST, FMT_WEIGHTS_BLOCKED_1ST, FMT_BIAS, FMT_DATA_BLOCKED16,
        2, 1, 1, 28, 28, 48, 13, 13, 4, 4, 0, 0, 2, 2),
    PARAMS(FMT_DATA_1ST, FMT_WEIGHTS_BLOCKED_1ST, FMT_BIAS, FMT_DATA_BLOCKED16,
        2, 1, 3, 28, 28, 48, 14, 14, 4, 4, 1, 1, 2, 2),
    PARAMS(FMT_DATA_1ST, FMT_WEIGHTS_BLOCKED_1ST, FMT_BIAS, FMT_DATA_BLOCKED16,
        2, 1, 3, 26, 26, 48, 13, 13, 4, 4, 1, 1, 2, 2),
    PARAMS(FMT_DATA_1ST, FMT_WEIGHTS_BLOCKED_1ST, FMT_BIAS, FMT_DATA_BLOCKED16,
        2, 1, 4, 84, 84, 48, 28, 28, 5, 5, 1, 1, 3, 3),
    PARAMS(FMT_DATA_BLOCKED16, FMT_WEIGHTS_BLOCKED_LAST, FMT_BIAS, nhwc,
        2, 1, 32, 28, 28, 1, 13, 13, 4, 4, 0, 0, 2, 2),
    PARAMS(FMT_DATA_BLOCKED16, FMT_WEIGHTS_BLOCKED_LAST, FMT_BIAS, nhwc,
        2, 1, 32, 28, 28, 3, 14, 14, 4, 4, 1, 1, 2, 2),
    PARAMS(FMT_DATA_BLOCKED16, FMT_WEIGHTS_BLOCKED_LAST, FMT_BIAS, nhwc,
        2, 1, 32, 26, 26, 3, 13, 13, 4, 4, 1, 1, 2, 2),
    PARAMS(FMT_DATA_BLOCKED16, FMT_WEIGHTS_BLOCKED_LAST, FMT_BIAS, nhwc,
        2, 1, 32, 84, 84, 4, 28, 28, 5, 5, 1, 1, 3, 3)
