...
static const rpd_create_f cpu_reorder_impl_list[] = {
    ...
    simple_reorder_t<f32, goihw, f32, gOhwi16o, fmt_order::keep>::pd_t::create,
    simple_reorder_t<f32, goihw, f32, gOhwi16o, fmt_order::reverse>::pd_t::create,
    simple_reorder_t<f32, goihw, f32, gOhw16oi, fmt_order::keep>::pd_t::create,
    simple_reorder_t<f32, goihw, f32, gOhw16oi, fmt_order::reverse>::pd_t::create,
    simple_reorder_t<f32, gOhwi16o, f32, gOhw16oi, fmt_order::keep>::pd_t::create,
    simple_reorder_t<f32, gOhwi16o, f32, gOhw16oi, fmt_order::reverse>::pd_t::create,
    simple_reorder_t<f32, goihw, f32, gIhw16io, fmt_order::keep>::pd_t::create,
    simple_reorder_t<f32, goihw, f32, gIhw16io, fmt_order::reverse>::pd_t::create,
    simple_reorder_t<f32, goihw, f32, gIhwo16i, fmt_order::keep>::pd_t::create,
    simple_reorder_t<f32, goihw, f32, gIhwo16i, fmt_order::reverse>::pd_t::create,
    simple_reorder_t<f32, gIhw16io, f32, gIhwo16i, fmt_order::keep>::pd_t::create,
    simple_reorder_t<f32, gIhw16io, f32, gIhwo16i, fmt_order::reverse>::pd_t::create,
