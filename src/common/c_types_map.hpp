...
namespace memory_format {
    ...
    const memory_format_t Ohw16oi = mkldnn_Ohw16oi;
    const memory_format_t Ihwo16i = mkldnn_Ihwo16i;
    const memory_format_t Ihw16io = mkldnn_Ihw16io;
    ...
    const memory_format_t gOhw16oi = mkldnn_gOhw16oi;
    const memory_format_t gIhwo16i = mkldnn_gIhwo16i;
    const memory_format_t gIhw16io = mkldnn_gIhw16io;
